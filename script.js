...
function populateRestModal(response, button){
    ...
    modalDescription.html(addressStr.bold() + response.businesses[id - 1].location.display_address[0]);
    modalDescription.append($("<br>"));
    modalDescription.append(response.businesses[id - 1].location.display_address[1]);
